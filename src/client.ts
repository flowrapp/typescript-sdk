...
export interface ClientOptions {
   ...
   *
   * Defaults to process.env['FLOWRAPP_BASE_URL'].
   */
   ...
   * Set the log level.
   *
   * Defaults to process.env['FLOWRAPP_LOG'] or 'warn' if it isn't set.
   */
...
export class Flowrapp {
  ...
  constructor({
    ...
    this.timeout = options.timeout ?? Flowrapp.DEFAULT_TIMEOUT /* 1 minute */;
    ...
    this.logLevel =
      ...
      parseLogLevel(readEnv('FLOWRAPP_LOG'), "process.env['FLOWRAPP_LOG']", this) ??
      defaultLogLevel;
    ...
    const customHeadersEnv = readEnv('FLOWRAPP_CUSTOM_HEADERS');
    if (customHeadersEnv) {
  ...
  static Flowrapp = this;
  static DEFAULT_TIMEOUT = 60000; // 1 minute

  static FlowrappError = Errors.FlowrappError;
