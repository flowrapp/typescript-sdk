...
The REST API documentation can be found on [flowrapp.github.io](https://flowrapp.github.io). The full API of this library can be found in [api.md](api.md).
...
1. Via the `FLOWRAPP_LOG` environment variable
...
const client = new Flowrapp({
  logger: logger.child({ name: 'Flowrapp' }),
