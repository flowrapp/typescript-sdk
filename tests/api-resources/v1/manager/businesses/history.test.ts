...
describe('resource history', () => {
  ...
  test.skip('day', async () => {
    const responsePromise = client.v1.manager.businesses.history.day(0);
  ...
  test.skip('day: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.v1.manager.businesses.history.day(
        0,
        { date: '2025-03-10' },
  ...
  test.skip('month', async () => {
    const responsePromise = client.v1.manager.businesses.history.month(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('month: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.v1.manager.businesses.history.month(
        0,
        { month: '2025-03' },
        { path: '/_stainless_unknown_path' },
      ),
  ...
  test.skip('week', async () => {
    const responsePromise = client.v1.manager.businesses.history.week(0);
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('week: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(
      client.v1.manager.businesses.history.week(
        0,
        { week: '2025-W31' },
        { path: '/_stainless_unknown_path' },
      ),
