...
- <code><a href="./src/resources/v1/auth/oauth.ts">CredentialRequest</a></code>

Methods:

- <code title="post /api/v1/auth/oauth/github">client.v1.auth.oauth.<a href="./src/resources/v1/auth/oauth.ts">githubAuthenticate</a>({ ...params }) -> TokenResponse</code>
- <code title="post /api/v1/auth/oauth/google">client.v1.auth.oauth.<a href="./src/resources/v1/auth/oauth.ts">googleAuthenticate</a>({ ...params }) -> TokenResponse</code>
